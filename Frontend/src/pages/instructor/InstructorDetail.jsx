      ...
      <div className="text-center mb-8">
        <div className="flex justify-center mb-4">
          {instructor.imgurl ? (
            ...
            <div className="w-32 h-32 rounded-full mx-auto bg-gray-300 flex items-center justify-center text-2xl font-bold text-white">
              {instructor.username.charAt(0).toUpperCase()}
            </div>
          )}
        </div>
        <h2 className="text-3xl font-bold">{instructor.username}</h2>
