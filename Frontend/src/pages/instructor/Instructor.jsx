  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        filterPT(data); // Filter personal trainers right after fetching
      } catch (error) {
              ...
              <div className="flex-col flex gap-6 md:gap-8">
                <div className='flex flex-col text-center'>
                  ...
                  {user.imgurl ? (
                    ...
                    <div className="w-32 h-32 rounded-full mx-auto my-4 bg-gray-300 flex items-center justify-center text-2xl font-bold text-white">
                  ...
                  <div className="text-left">
                    ...
                    <p className='text-gray-500 mb-3'>Phone: {user.phoneNum}</p> {/* Displaying phone number */}
                  </div>
                </div>
              </div>
            </div>
