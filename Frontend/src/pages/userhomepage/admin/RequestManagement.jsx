  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-4">
        ...
        <button onClick={() => setActiveTab('joinClass')} className={`px-4 py-2 rounded ${activeTab === 'joinClass' ? 'bg-blue-500 text-white' : 'bg-gray-200'}`}>Join Class Requests</button>
      </div>

      {/* Conditional Rendering based on Active Tab */}
      {activeTab === 'classes' && <ClassRequests />}
      {activeTab === 'joinClass' && <JoinRequests/>}
    </div>
  );
};
